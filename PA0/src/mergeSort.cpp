  ...
  while ( leftIndex <= middle1 && rightIndex <= right )
    {
      ...
      if ( data[ leftIndex ] <= data[ rightIndex ] )
		combined[ combinedIndex++ ] = data[ leftIndex++ ]; //TODO : copy left element into working vector
	  else
		combined[ combinedIndex++ ] = data[ rightIndex++ ]; //TODO : copy right element into working vector
    } // end while
  
  if ( leftIndex == middle2 ) // if at end of left vector          
    {                                                               
      // copy in rest of right vector
	  while ( rightIndex <= right ) //TODO : copy right vector into working vector
          combined[ combinedIndex++ ] = data[ rightIndex++ ];
    } // end if                                                     
  else // at end of right vector                                   
    {                                                               
       // copy in rest of left vector
      while ( leftIndex <= middle1 ) //TODO : copy left vector into working vector
		  combined[ combinedIndex++ ] = data[ leftIndex++ ];

    } // end else                                                   
  
  //TODO : copy values back into original vector
  for ( int i = left; i <= right; i++ ) // copy values back into original vector
	data[ i ] = combined[ i ];
